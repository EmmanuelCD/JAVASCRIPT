...
- Una cadena de texto que se llame "estudianteMinus" que contenga la cadena
 estudiante pero todo en minúsculas
...
let finalLetraApellidp = apellido.substring(apellido.length - 1, apellido.length);

let ContradorSinEspacios = estudiante.replace(/ /g,"");

let nombreValidar = estudiante.includes(nombre);
